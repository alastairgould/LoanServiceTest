...
public record LoanApplication(Guid Id, string Name, string Email, int MonthlyIncome, decimal RequestedAmount, int TermMonths, string Status, DateTime CreatedAt, DateTime? ReviewedAt);
